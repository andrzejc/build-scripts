...
*64)
    ...
    bin/winstall-lame "${TARGET_PLATFORM}" https://www.videohelp.com/download/lame3.100-20190806.zip 34d4c82e9a6c2a8516dae5a427b9e5d33876eb42 \
        "https://sourceforge.net/p/lame/svn/HEAD/tree/tags/RELEASE__3_100/lame/include/lame.h?format=raw"
    ;;
*in32|*86)
    ...
    bin/winstall-lame "${TARGET_PLATFORM}" https://www.videohelp.com/download/lame3.100-64-20190806.zip 856c9881318e5c54e1b8fd6fceb24b6d1c4a88d1 \
        "https://sourceforge.net/p/lame/svn/HEAD/tree/tags/RELEASE__3_100/lame/include/lame.h?format=raw"
    ;;
*)
