...
*64)
    ...
    bin/winstall-fftw3  ftp://ftp.fftw.org/pub/fftw/fftw-3.3.5-dll64.zip 409f4a5272506eb7422d265a68a02deeefcb5c17
    ;;
*in32|*86)
    ...
    bin/winstall-fftw3 ftp://ftp.fftw.org/pub/fftw/fftw-3.3.5-dll32.zip b19d875b07a0e4ac8251b0aa072321582374e000
    ;;
*)
