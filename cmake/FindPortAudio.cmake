...
function(_find_portaudio)
    ...
    if(PortAudio_FOUND)
        ...
        if(NOT DEFINED PortAudio_ROOT)
            if(DEFINED ENV{PortAudio_ROOT})
                file(TO_CMAKE_PATH "$ENV{PortAudio_ROOT}" PortAudio_ROOT)
            else()
                get_filename_component(PortAudio_ROOT "${PortAudio_INCLUDE_DIR}" DIRECTORY)
            endif()
            set(PortAudio_ROOT "${PortAudio_ROOT}" PARENT_SCOPE)
        endif()
    endif()
endfunction()
