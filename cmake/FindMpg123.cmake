...
function(_find_mpg123)
    ...
    if(Mpg123_FOUND)
        ...
        if(NOT DEFINED Mpg123_ROOT)
            if(DEFINED ENV{Mpg123_ROOT})
                file(TO_CMAKE_PATH "$ENV{Mpg123_ROOT}" Mpg123_ROOT)
            else()
                get_filename_component(Mpg123_ROOT "${Mpg123_INCLUDE_DIR}" DIRECTORY)
            endif()
            set(Mpg123_ROOT "${Mpg123_ROOT}" PARENT_SCOPE)
        endif()
    endif()
endfunction()
